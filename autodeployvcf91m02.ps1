...
# Adapted from autodeployvcf9m02.ps1 — Target: VCF 9.1 direct deployment
#
# Deployment path:
#   1. This script deploys Nested ESXi 9.1 + VCF Installer (SDDC Mgr 9.1) for M02
#   2. Run vcf9-bringup.ps1 to bring up VCF 9.1 on M02 (10.0.1.14–17, SDDC .18)
#
