...
# Adapted from autodeployvcf9m03.ps1 — Target: VCF 9.1 via 9.0.2 + LCM upgrade
#
# Deployment path:
#   1. This script deploys Nested ESXi (9.0.2) + VCF Installer (SDDC Mgr 9.0.2) for M03
#   2. Run vcf9-bringup.ps1 to bring up VCF 9.0.2 on M03 (10.0.1.50–53, SDDC .56)
#   3. Use SDDC Manager LCM with the 9.1 bundle (E:\9.1\VCF-SDDC-Manager-
#      Appliance-9.1.0.0.25371088.ova) to upgrade to 9.1
#
# IP usage: same as M03 (10.0.1.50–53, SDDC 10.0.1.56) — replaces the M03 deployment.
...
$VCFInstallerVMName        = "vcf-m03-inst01"
$VCFInstallerFQDN          = "vcf-m03-inst01.$VMDomain"
...
$VCFInstanceName   = "vcf-m03"
$VCFManagementPool = "vcf-m03-cl01-np01"
$CEIPEnabled       = $true
$VSANESAEnabled    = $false   # set $true if using vSAN ESA

# SDDC Manager Configuration
$SddcManagerHostname      = "vcf-m03-sddcm01"
$SddcManagerIP            = "10.0.1.56"
$SddcManagerRootPassword  = "VMware1!VMware1!"
$SddcManagerSSHPassword   = "VMware1!VMware1!"
$SddcManagerLocalPassword = "VMware1!VMware1!"

# Nested ESXi VMs for Management Domain (M03)
$NestedESXiHostnameToIPs = @{
    "vcf-m03-esx01" = "10.0.1.50"
    "vcf-m03-esx02" = "10.0.1.51"
    "vcf-m03-esx03" = "10.0.1.52"
    "vcf-m03-esx04" = "10.0.1.53"
}
...
$VCSAName           = "vcf-m03-vc01"
$VCSAIP             = "10.0.1.55"
$VCSARootPassword   = "VMware1!"
$VCSASSOPassword    = "VMware1!"
$VCSASize           = "tiny"     # tiny / small / medium / large / xlarge
$VCSADatacenterName = "vcf-m03-dc01"
$VCSAClusterName    = "vcf-m03-cl01"

# vSAN Configuration
$VSANDatastoreName = "vcf-m03-cl01-ds-vsan01"
...
$NSXManagerVIPHostname  = "vcf-m03-nsx01"
$NSXManagerVIPIP        = "10.0.1.58"
$NSXManagerNodeHostname = "vcf-m03-nsx01a"
$NSXManagerNodeIP       = "10.0.1.57"
$NSXTransportVlanId     = 9
$NSXRootPassword        = "VMware1!VMware1!"
$NSXAdminPassword       = "VMware1!VMware1!"
$NSXAuditPassword       = "VMware1!VMware1!"

# NSX TEP (Tunnel Endpoint) IP Pool
$NSXTEPPoolName = "nsx-vtep-m03"
$NSXTEPPoolDesc = "NSX TEP Pool for vcf-m03"
$NSXTEPSubnet   = "192.168.29.0/24"
$NSXTEPGateway  = "192.168.29.254"
$NSXTEPStartIP  = "192.168.29.13"
$NSXTEPEndIP    = "192.168.29.28"
...
$vMotionVlanId      = 3
$vMotionStartIP     = "192.168.13.13"
$vMotionEndIP       = "192.168.13.16"
$vSANNetworkCidr    = "192.168.14.0/24"
$vSANGateway        = "192.168.14.254"
$vSANVlanId         = 4
$vSANStartIP        = "192.168.14.13"
$vSANEndIP          = "192.168.14.16"

# VCF Operations Configuration
$VCFOpsHostname      = "vcf-m03-ops01.$VMDomain"
...
if($confirmDeployment -eq 1) {
    ...
    Write-Host -ForegroundColor Yellow "---- VCF 9 Automated Lab Deployment Configuration (M03) ----"
    ...
    Write-Host -ForegroundColor Yellow "`n---- VCF Installer (M03) ----"
    ...
    Write-Host -ForegroundColor Yellow "`n---- vCenter (M03) ----"
    Write-Host -NoNewline -ForegroundColor Green "Hostname: "
    Write-Host -ForegroundColor White "$VCSAName.$VMDomain"
    Write-Host -NoNewline -ForegroundColor Green "IP: "
    Write-Host -ForegroundColor White $VCSAIP

    Write-Host -ForegroundColor Yellow "`n---- NSX Manager (M03) ----"
...
if($deployNestedESXiVMs -eq 1) {
    $NestedESXiHostnameToIPs.GetEnumerator() | Sort-Object -Property Value | Foreach-Object {
        ...
        $vm = Import-VApp -Source $NestedESXiApplianceOVA -OvfConfiguration $ovfconfig -Name $VMName -Location $VMCluster -VMHost $vmhost -Datastore $datastore -DiskStorageFormat thin -ErrorAction Stop

        if($vm -eq $null) {
            My-Logger "ERROR: Import-VApp returned null for $VMName, skipping ..." "red"
            continue
        }
...
"@
    ...
    My-Logger "Generating VCF 9 Installer deployment config: vcf9-m03-config.json"
    $vcfConfig | Out-File -LiteralPath vcf9-m03-config.json -Encoding utf8
    ...
    My-Logger "4. Upload vcf9-m03-config.json or use the wizard" "yellow"
...
My-Logger "VCF 9 M03 Lab Deployment Complete!"
